...
import NewSellerModal from 'src/components/Modal/NewSellerModal/NewSellerModal';
  ...
  return (
    <Container>
      <Stack spacing={20}>
        <Header
          title="Sellers"
          text="View and manage your sellers."
          showButton={true}
          buttonText="New seller"
          onClick={() => {
            openModal({
              children: <NewSellerModal />,
              title: 'Create seller',
            });
          }}
        />
